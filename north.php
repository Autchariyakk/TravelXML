...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="css/britro.css">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown active">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="active"><a href="north.php">เหนือ</a></li>
...
for (i=0;i<x.length;i++){
  if((x[i].getElementsByTagName("bis_tag")[0].childNodes[0].nodeValue)=="เหนือ"){
...
<footer class="col-xs-12">
    <img class="m2 col-xs-4" src="img/logo1.png" />
